...
function HubDot({
  ...
  return (
    ...
    >
      <span className="relative flex h-5 w-5 items-center justify-center sm:h-6 sm:w-6 lg:h-7 lg:w-7">
        <span
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-[220px] w-[220px] sm:h-[300px] sm:w-[300px] lg:h-[420px] lg:w-[420px]">
        ...
        {hubs.map((hub, i) => (
          <HubDot key={hub.id} hub={hub} index={i} total={hubs.length} onOpen={onOpen} />
        ))}
      </div>
