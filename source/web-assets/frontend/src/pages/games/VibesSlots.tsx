        ...
        {lastResult && (
          ...
          >
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
              ...
              <div><div className="text-[10px] text-neutral-500 uppercase">Reward</div><div className={`font-mono font-bold ${lastResult.gross_payout > 0 ? "text-emerald-300" : "text-neutral-500"}`}>₵{lastResult.gross_payout.toFixed(2)}</div></div>
            </div>
            {lastResult.is_jackpot_hit && (
