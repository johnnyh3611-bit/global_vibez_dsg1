      ...
      <div className="pt-20 sm:pt-24 pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {filteredStreams.length === 0 && (
            <div className="text-center py-12 max-w-md mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
              ...
              <p className="text-white/70 mb-6">No one is broadcasting in this category right now. Try another category or start your own.</p>
              <button
