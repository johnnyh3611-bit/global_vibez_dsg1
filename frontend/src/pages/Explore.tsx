...
export const EXPLORE_REGISTRY: Entry[] = [
  ...
  { route: '/beta-hub', title: 'Beta Hub · 2026-05-22 Build', subtitle: 'View + test every feature shipped in this build (health pings · open buttons)', cat: 'streaming', tags: ['beta', 'hub', 'qa', 'test', 'health'] },
