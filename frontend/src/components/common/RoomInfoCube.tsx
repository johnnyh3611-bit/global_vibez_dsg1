  ...
  return (
    <>
      <button
        ...
        className="fixed top-[8.5rem] left-3 z-[55] flex items-center gap-2 rounded-full border-2 border-cyan-400/50 bg-black/80 backdrop-blur-md pl-1.5 pr-3 py-1.5 text-[11px] uppercase tracking-widest text-cyan-200 hover:bg-cyan-500/30 hover:border-cyan-300 hover:text-white transition shadow-[0_0_20px_-4px_rgba(34,211,238,0.6)] group"
      >
